...
public final class Constants {
  ...
  public static final class Motors {
    //Gripper
    public static final CANSparkMax GRIPPER_ROTATE = new CANSparkMax(6, CANSparkMaxLowLevel.MotorType.kBrushless);
    public static final CANSparkMax GRIPPER = new CANSparkMax(8, CANSparkMaxLowLevel.MotorType.kBrushless); //TODO get CAN IDs
  }
